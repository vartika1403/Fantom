...
public class Conf {
    ...
    public static final String FIREBASE_DOMAIN_URI = "https://fraternity-2cb7b-default-rtdb.firebaseio.com/categories";//meetup URI
    public static final String FIREBASE_USER_URI = "https://fraternity-2cb7b-default-rtdb.firebaseio.com/users";
